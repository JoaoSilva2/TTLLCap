...
def main():
    ...
    image_ids = [ref['image_id'] for ref in candidates]
    candidates = [candidates[i]['caption'] for i in range(len(image_ids))]
    full_ids = [str(image_id).zfill(12) + ".jpg" for image_id in image_ids]
    image_paths = [args.image_dir + image_path for image_path in full_ids]
